...
export const DASS_ITEMS: DASSItem[] = [
  ...
  { id: 2,  text: "Me he dado cuenta de que tenía la boca seca",                                                                                                    subscale: "anxiety" },
  { id: 3,  text: "No he podido sentir ningún sentimiento positivo",                                                                                                subscale: "depression" },
  { id: 4,  text: "He tenido dificultad para respirar (por ejemplo, respiración excesivamente rápida o sensación de ahogo sin haber realizado ningún esfuerzo físico)", subscale: "anxiety" },
  { id: 5,  text: "Me ha resultado difícil tener iniciativa para hacer cosas",                                                                                      subscale: "depression" },
  { id: 6,  text: "He tendido a reaccionar de forma exagerada ante las situaciones",                                                                                subscale: "stress" },
  { id: 7,  text: "He sentido temblores (por ejemplo, en las manos)",                                                                                               subscale: "anxiety" },
  { id: 8,  text: "He sentido que estaba gastando una gran cantidad de energía nerviosa",                                                                           subscale: "stress" },
  ...
  { id: 12, text: "Me ha resultado difícil relajarme",                                                                                                              subscale: "stress" },
  { id: 13, text: "Me he sentido desanimado/a y triste",                                                                                                            subscale: "depression" },
  { id: 14, text: "He sido intolerante con las cosas que me impedían continuar con lo que estaba haciendo",                                                         subscale: "stress" },
  { id: 15, text: "He sentido que estaba al borde del pánico",                                                                                                      subscale: "anxiety" },
  { id: 16, text: "No he sido capaz de entusiasmarme con nada",                                                                                                    subscale: "depression" },
  { id: 17, text: "He sentido que no valía mucho como persona",                                                                                                    subscale: "depression" },
  { id: 18, text: "He sentido que estaba bastante irritable",                                                                                                       subscale: "stress" },
  { id: 19, text: "He notado los latidos de mi corazón sin haber realizado ningún esfuerzo físico",                                                               subscale: "anxiety" },
  { id: 20, text: "He tenido miedo sin ninguna razón aparente",                                                                                                    subscale: "anxiety" },
